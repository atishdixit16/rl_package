...
if __name__ == "__main__":
    ...
    for i in range(1,6):
        ...
        model_output = ppo_algorithm(env, model, NUM_ENV=8,
                  ...
                  CLIP_PARAM=0.1, VF_COEF=0.5, ENT_COEF=0.05,
                  GAMMA=0.99, LAMBDA=0.95,
                  LEARNING_RATE=1e-3,
                  PRINT_FREQ=8000, N_TEST_ENV=96, 
                  SAVE_RESULTS=True, FILE_PATH='MountainCarContinuous_results/', LOG_FILE_NAME='log'+str(i), SAVE_MODEL=True, MODEL_FILE_NAME='model'+str(i),
                  SEED=i)